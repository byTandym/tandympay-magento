...
namespace Tandym\Tandympay\Block\Adminhtml\System\Config\Fieldset;
...
/**
 * Fieldset renderer for Tandym solution
 */
class Payment extends Fieldset
{
    ...
    protected function _getHeaderTitleHtml($element)
    {
        ...
        $html .= '<div class="button-container"><button type="button"' .
            ...
            (empty($groupConfig['tandym_ec_separate']) ? '' : ' tandym-ec-separate') .
            $disabledClassString .
            '" id="' .
            $htmlId .
            '-head" onclick="tandymToggleSolution.call(this, \'' .
            $htmlId .
            "', '" .
            $this->getUrl(
                'adminhtml/*/state'
    ...
    protected function _getExtraJs($element)
    {
        $script = "require(['jquery', 'prototype'], function(jQuery){
            window.tandymToggleSolution = function (id, url) {
                var doScroll = false;
